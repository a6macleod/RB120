...
module Mailing
  ...
  def delivery_destination(destination, mail)
...
puts johns_postal_service.delivery_destination(ellens_postal_service.street_address, Postcard.new('Greetings from Silicon Valley!'))
